...
Locator: getByText('text=[KF365] 햇 양파 1.8kg')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('text=[KF365] 햇 양파 1.8kg')

    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\ui\ui_search.spec.ts:12:30
```
...
```ts
  ...
  11 |   const productTitle = page.getByText('text=[KF365] 햇 양파 1.8kg');
> 12 |   await expect(productTitle).toBeVisible();
     |                              ^ Error: Timed out 5000ms waiting for expect(locator).toBeVisible()
  13 | });
```