...
- Name: 🎬 영화 상세정보 API 테스트 >> 🔍 영화 ID 429 - "The Good, the Bad and the Ugly" 상세 정보 검증
...
Received: "Il buono, il brutto, il cattivo"
    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_1.spec.ts:62:35
```
