...
Call log:
  - waiting for locator('.css-ahkst0.e4nu7ef3')

    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\ui\ui_cart_product_cancel.spec.ts:21:46
```
...
> 21 |   await page.locator('.css-ahkst0.e4nu7ef3').click();
     |                                              ^ Error: locator.click: Test timeout of 150000ms exceeded.
  22 |
  23 |   // const AddCartBtn = page.locator("xpath=(//button[@class='css-ahkst0 e4nu7ef3'])[1]")
  24 |   await page.locator
  25 |   // await expect(page).toHaveURL('https://www.kurly.com/cart');
  26 |
  27 |   // await page.getByRole('button', { name: '2', exact: true }).click();
  28 |   // await page.getByText('전체선택 2/').click();
  29 |   // await page.getByText('전체선택 0/').click();
  30 |   // await page.getByRole('button', { name: '선택삭제' }).click();
  31 |   // await page.getByRole('button', { name: 'confirm-button' }).click();
  32 |   // await page.getByText('전체선택 0/').click();
  33 |   // await expect(page.getByText('장바구니에 담긴 상품이 없습니다.')).toBeVisible();
  34 | });
```