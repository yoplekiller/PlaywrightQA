...
Locator: locator('p').nth(3)
Expected string: "2"
Received string: "샛별배송"
Call log:
  - expect.toHaveText with timeout 5000ms
  - waiting for locator('p').nth(3)
    9 × locator resolved to <p class="kpds_97oqoup kpds_97oqouv kpds_97oqou5 kpds_ldmw177i kpds_97oqou19 kpds_97oqouj kpds_ldmw177w kpds_97oqou12 kpds_97oqouc kpds_ldmw177p kpds_126coma4 kpds_126coma8 kpds_126coma3 kpds_ldmw171a0">샛별배송</p>
      - unexpected value "샛별배송"
...
```ts
   ...
   8 |   await page.getByRole('link', { name: '+20%쿠폰 담기 샛별배송 [KF365] 당도선별 수박 4kg 이상 시원하고 달콤한 과즙이 듬뿍 29,900원 16%24,900원 999+' }).getByRole('button').click();
   9 |   await page.getByRole('button', { name: '장바구니 담기' }).click();
  10 |   await page.getByRole('link', { name: '+20%쿠폰 담기 샛별배송 [KF365] 당도선별 수박 4kg 이상 시원하고 달콤한 과즙이 듬뿍 29,900원 16%24,900원 999+' }).getByRole('button').click();
  11 |   await page.getByRole('button', { name: '장바구니 담기' }).click();
  12 |   await page.getByRole('button', { name: '상품 이미지 [KF365] 당도선별 수박 4kg' }).click();
  13 |   await page.getByRole('button', { name: '1', exact: true }).click();
  14 |
  15 |   const quantityLocator = page.locator('p').nth(3);
