...
- Name: TMDB 인기 영화 API 응답 확인
- Location: C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_popular_movie.spec.ts:29:5
...
Expected: 200
Received: 404
    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_popular_movie.spec.ts:34:29
```
...
```ts
  ...
  26 | // });
  27 | import { test, expect, request } from '@playwright/test';
  28 |
  29 | test('TMDB 인기 영화 API 응답 확인', async () => {
  30 |   const apiContext = await request.newContext({
  31 |     baseURL: process.env.TMDB_BASE_URL,
  32 |   });
  33 |   const response = await apiContext.get(`/movie/popular?api_key=${process.env.TMDB_API_KEY}`);
