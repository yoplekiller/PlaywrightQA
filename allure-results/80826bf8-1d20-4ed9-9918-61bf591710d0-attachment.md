...
- Name: 🎬 영화 페이지 SLA 응답 시간 테스트 >> 🔄 /genre/movie/list?api_key=your_api_key_here&language=ko-KR 응답 시간 확인
...
Expected: 200
Received: 401
    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_sla.spec.ts:39:33
```
