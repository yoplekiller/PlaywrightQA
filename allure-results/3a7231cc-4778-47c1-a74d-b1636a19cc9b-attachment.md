...
Call log:
  ...
  - waiting for locator('p.kpds_j1jks21')
    9 × locator resolved to <p class="kpds_97oqoup kpds_97oqouv kpds_97oqou5 kpds_ldmw177i kpds_97oqou19 kpds_97oqouj kpds_ldmw177w kpds_97oqou12 kpds_97oqouc kpds_ldmw177p kpds_j1jks21">2</p>
      - unexpected value "2"
...
```ts
  ...
  14 |
  15 |   const quantityLocator = page.locator('p.kpds_j1jks21');
> 16 |   await expect(quantityLocator).toHaveText('7');
     |                                 ^ Error: Timed out 5000ms waiting for expect(locator).toHaveText(expected)
  17 | });
```