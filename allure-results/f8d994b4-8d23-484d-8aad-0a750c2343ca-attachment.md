...
Call log:
  - waiting for locator('xpath=(//button[@class=\'css-g25h97 e14oy6dx1\'])')
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    260 × waiting for element to be visible, enabled and stable
        - element is visible, enabled and stable
        - scrolling into view if needed
        - done scrolling
        - <div tabindex="-1" role="presentation" class="MuiDialog-container MuiDialog-scrollPaper css-ekeie0">…</div> from <div role="presentation" class="MuiModal-root MuiDialog-root css-98q5jm">…</div> subtree intercepts pointer events
    ...
    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\ui\ui_cart_product_cancel.spec.ts:26:73
```
...
```ts
  ...
  23 |
  24 |
  25 |   await page.locator("xpath=(//button[@class='css-ahkst0 e4nu7ef3'])[1]")
> 26 |   await page.locator("xpath=(//button[@class='css-g25h97 e14oy6dx1'])").click();
     |                                                                         ^ Error: locator.click: Test timeout of 150000ms exceeded.
