...
- Location: C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_login_post.spec.ts:26:5
...
Expected value: "API KEY"
Received value: "Missing API key."
    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_login_post.spec.ts:44:16
```
...
> 44 |   expect(data).toHaveProperty('error', 'API KEY');
     |                ^ Error: expect(received).toHaveProperty(path, value)
  45 | });
  46 |
