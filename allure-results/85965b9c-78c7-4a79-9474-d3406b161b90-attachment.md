...
- Name: 🎬 영화 상세정보 API 테스트( Dark Night는 잘못된 ID값) >> 🔍 영화 ID 155 - "The Dark Knight" 상세 정보 검증
- Location: C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_search_movie.spec.ts:53:9
...
Expected: "2008-07-17"
Received: "2008-07-16"
    at C:\Users\jmlim\OneDrive\Desktop\PlaywrightQA\tests\api\api_search_movie.spec.ts:69:35
```
...
```ts
  ...
  32 |
  33 | test.describe('🎬 영화 상세정보 API 테스트( Dark Night는 잘못된 ID값)', () => {
