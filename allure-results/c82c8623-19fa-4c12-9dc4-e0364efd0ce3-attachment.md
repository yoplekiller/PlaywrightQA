...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e75]:
      ...
      - generic [ref=e78]:
        - generic [ref=e79]:
          - textbox "아이디를 입력해주세요" [ref=e82]
          - textbox "비밀번호를 입력해주세요" [ref=e85]
        - generic [ref=e86]:
          - generic [ref=e87] [cursor=pointer]: 아이디 찾기
          - generic [ref=e89] [cursor=pointer]: 비밀번호 찾기
        - generic [ref=e90]:
          - button "로그인" [ref=e91] [cursor=pointer]:
            - generic [ref=e92]: 로그인
          - button "회원가입" [ref=e93] [cursor=pointer]:
            - generic [ref=e94]: 회원가입
        - generic [ref=e95]:
          - paragraph [ref=e96]: 간편 로그인
          - button "네이버로 계속하기" [ref=e97] [cursor=pointer]:
            - img [ref=e98]
            - paragraph [ref=e101]: 네이버로 계속하기
          - button "카카오로 계속하기" [ref=e102] [cursor=pointer]:
            - img [ref=e103]
            - paragraph [ref=e105]: 카카오로 계속하기
    - generic [ref=e106]:
      - generic [ref=e107]:
        - generic [ref=e108]:
          - generic [ref=e109]:
            - paragraph [ref=e110]: 고객행복센터
            - strong [ref=e111]: 1644-1107월~토요일 오전 7시 - 오후 6시
            - generic [ref=e112]:
              - generic [ref=e113]:
                - button "카카오톡 문의" [ref=e114] [cursor=pointer]
                - generic [ref=e115]:
                  - text: 월~토요일
                  - img [ref=e116]
                  - text: 오전 7시 - 오후 6시
                  ...
                  - text: 오전 7시 - 오후 1시
              - generic [ref=e118]:
                - button "1:1 문의" [ref=e119] [cursor=pointer]
                - generic [ref=e120]:
                  - text: 365일
                  - text: 고객센터 운영시간에 순차적으로 답변드리겠습니다.
              - generic [ref=e121]:
                - link "대량주문 문의" [ref=e122] [cursor=pointer]:
            ...
            - generic [ref=e126]:
              - text: "비회원 문의 :"
              - link "help@kurlycorp.com" [ref=e127] [cursor=pointer]:
          ...
          - generic [ref=e128]:
            - list [ref=e129]:
              ...
              - listitem [ref=e142]:
                - link "이용안내" [ref=e143] [cursor=pointer]:
                  - /url: /user-guide
              - listitem [ref=e144]:
                - link "입점신청" [ref=e145] [cursor=pointer]:
            ...
            - generic [ref=e146]:
              ...
              - link "사업자정보 확인" [ref=e148] [cursor=pointer]:
              ...
              - text: "대표이사 : 김슬아"
              - text: "채용문의 :"
              - link "recruit@kurlycorp.com" [ref=e150] [cursor=pointer]:
                - /url: mailto:recruit@kurlycorp.com
              - text: "팩스: 070 - 7500 - 6098"
            - list [ref=e151]:
              - link "컬리 인스타그램 바로가기" [ref=e152] [cursor=pointer]:
                - /url: https://instagram.com/marketkurly
                - img "컬리 인스타그램 바로가기"
              - link "컬리 페이스북 바로가기" [ref=e153] [cursor=pointer]:
                - /url: https://www.facebook.com/marketkurly
                - img "컬리 페이스북 바로가기"
              - link "컬리 네이버블로그 바로가기" [ref=e154] [cursor=pointer]:
                - /url: https://blog.naver.com/marketkurly
                - img "컬리 네이버블로그 바로가기"
              - link "컬리 유튜브 바로가기" [ref=e155] [cursor=pointer]:
